...
<title><s:if test="#attr.clazz!=null">信息编辑</s:if><s:else>信息增加</s:else>班级信息</title>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.clazz!=null">信息编辑， </s:if><s:else>信息增加， </s:else>班级信息</TD>
       ...
       <table width="100%" align="center" cellpadding="0" cellspacing="0" class="editbody">
        <tr class="editbody">
          <td align="center" height="30">
          	...
          	<input type="button" id="editBtn" Class="btnstyle" value="信息编辑"/> 
          	</s:if>
          	<s:else>
          	<input type="button" id="addBtn" Class="btnstyle" value="信息增加" />
          	</s:else>
