...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="button" value="增加" onclick="window.location='Admin_addEvaluateShow.action';" class="btnstyle"/> &nbsp;
      </s:if>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_editEvaluate.action?paramsEvaluate.evaluate_id=%{#evaluate.evaluate_id}">编辑</s:a>
     </td>
     </s:if>
   </tr> 
   </s:iterator>
   ...
   <s:else>
   <tr>
     <td height="60" colspan="11" align="center"><b>&lt;不存在教师评教信息&gt;</b></td>
   </tr>
   </s:else>
