...
<title><s:if test="#attr.score!=null && #attr.score.score_id!=0">编辑</s:if><s:else>添加</s:else>选修成绩</title>
...
$(document).ready(function(){
    ...
    function loadStudent(score_year,score_year_half,course_id){
    	if(score_year!='' && score_year_half!='0' && course_id!='0'){
    		...
    		$("#op2").show();
    		var postParams={'paramsScource.scource_year':score_year,'paramsScource.scource_year_half':score_year_half,'paramsScource.course_id':course_id};
    		$.post('queryStudent2.action',postParams,
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">选修成绩&gt;&gt;<s:if test="#attr.score!=null && #attr.score.score_id!=0">编辑</s:if><s:else>添加</s:else>选修成绩</span>
</div>
<form id="info" name="info" action="Admin_addScoreSelect.action" method="post">   
<s:hidden id="paramsScore.score_id" name="paramsScore.score_id" value="%{#attr.score.score_id}" /> 
<s:hidden id="paramsScore.course_type" name="paramsScore.course_type" value="2" /> 
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.score!=null && #attr.score.score_id!=0">编辑</s:if><s:else>添加</s:else>选修成绩</TD>
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       ...
       <tr>
          ...
          <td>
          	<s:select list="#attr.courses" id="course_id" name="paramsScore.course_id"  value="%{#attr.score.course_id}"
          		listKey="course_id" listValue="course_name" headerKey="0" headerValue="请选择" cssStyle="width:155px">
            </s:select>
          </td>
        </tr> 
        <tr>
